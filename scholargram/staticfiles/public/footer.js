document.write('            <footer id="footer" class="content">');
document.write('                <div class="row">');
document.write('                    <div class="1u">');
...
document.write('                                    <ul class="alt1">');
document.write('                                        <li><a href="/">Home</a></li>');
document.write('                                        <li><a href="/catalog/">Books Published</a></li>');
...
document.write('                                        <li><a href="/faq/">FAQs</a></li>');
document.write('                                        <li><a href="/dashboard/">Dashboard</a></li>');
...
document.write('                            <p>Email:<br>');
document.write('                            contact@scholargram.com<br>');
document.write('                        </section>');
document.write('                    </div>');
document.write('                            <div class="2u">');
document.write('                                <section>');
...
document.write('            &copy; 2019 <a href="//www.self-publish.in">White Falcon Publishing Solutions LLP</a>. All rights reserved </p>');
document.write('        </center>');
document.write('        </div>');
document.write('        </div>');
